...
import com.example.spp.security.handler.RestAccessDeniedHandler;
import com.example.spp.security.handler.RestAuthenticationEntryPoint;
import com.example.spp.security.service.JwtAuthenticationFilter;
import com.example.spp.security.service.JwtAuthenticationProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] allowedUrlsForPost = new String[]{ "/auth/login", "/addNewOrder",
    ...
    private static final String[] allowedUrlsForPut = new String[]{ "/updateItem", "/updateUser",
            "/updateStorage", "/updateCompany", "/updateOrder" };
    ...
    private static final String[] allowedUrlsForGet = new String[]{ "/getAllDataFromItems",  "/document/printListOfUsers/*",
            ...
            "/document/printListOfItems/*", "/getAllDataFromOrders", "/document/printTaxes/*",  "/document/printListOfStorages/*",
            "/document/printListOfProviders/*", "/document/printDriversSchedule/*", "/document/printListOfOrders/*"};
